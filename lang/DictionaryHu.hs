...
dict = DictionaryFile {
  ...
  entries =
    ...
    , msg_Submission_SubmissionFormDeadlineReached <| "A határidő lejárt."
    ...
    , msg_Submission_Info <| "A beadott megoldásokhoz a beadás után még hozzászólások írhatóak."
    ...
    , msg_Submission_NoSubmittedSolutions <| "Nincsenek még beadott megoldások."
