...
type GETContentHandler  = ContentHandler PageContents
type POSTContentHandler = ContentHandler Action
type ViewPOSTContentHandler = ContentHandler PageContents
...
-- as a UserAction with a given UserStory.
