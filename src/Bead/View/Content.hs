...
type POSTContentHandler = ContentHandler (Either IHtml UserAction)
...
setUserAction :: UserAction -> ContentHandler (Either IHtml UserAction)
setUserAction = return . Right

setErrorContents :: html -> ContentHandler (Either html a)
setErrorContents = return . Left
