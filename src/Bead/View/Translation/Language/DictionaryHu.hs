...
dictionaryHu = DF.DictionaryFile {
  ...
  DF.entries =
    ...
    , msg_NewAssignment_MustBePositive <| "Pozitívnak kell lennie."
    , msg_NewAssignment_MustBeAPositiveInt <| "Egy pozitív egész számot kell megadni."
    , msg_NewAssignment_CannotBeEmpty <| "Nem maradhat üresen."
    , msg_NewAssignment_FreeFormEvaluation <| "Szabadformátumú kiértékelés"
    , msg_Assessment_CannotBeEmpty <| "Nem lehet üres."
    , msg_Assessment_CannotChange <| "Nem változtatható meg."
