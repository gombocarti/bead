...
dictionaryHu = DF.DictionaryFile {
  ...
  DF.entries =
    ...
    , msg_Welcome_ClickNavigation <| "Kattints egy elemre a navigációs menüben!"
    ...
    , msg_CourseAdmin_GroupAdmins_Info <| "Az alábbi táblázat minden sora egy csoport nevét és a csoporthoz hozzárendelt oktatókat tartalmazza."
    ...
    , msg_AssignmentDoesntHaveSubmissions <| "A feladatra még nem adtak be megoldást."
    ...
    , msg_NewAssignment_TestFile_Info <| "Egy (tesztadatokat tartalmazó) állomány adható meg itt, amelyet a tesztelő megkap.  Állományok az \"%s\" oldalon keresztül tölthetők fel."
    ...
    , msg_NewAssignment_Info_Isolated <| "(Zárthelyihez javasolt) A hallgató által más feladatokra beküldött megoldások nem láthatók a hallgató számára, egy vagy több aktív izolált feladat jelenlétében. Megjegyzés: ha több mint egy izolált feladat van akkor mindegyikre a hallgató által beadott megoldás elérhető a hallgató számára."
    ...
    , msg_GroupRegistration_NewGroup <| "Új csoport"
    ...
    , msg_GroupRegistration_Group <| "Csoport"
    , msg_GroupRegistration_Admin <| "Oktató"
    ...
    , msg_GroupRegistration_Warning <| "Amíg nincs beadott megoldás, addig le lehet iratkozni az adott csoportról vagy egy másik csoport kiválasztásával át lehet menni abba a csoportba.  Ha már van beadott megoldás, akkor a gyakorlatvezetőt kell megkérni, hogy töröljön a csoportból."
    ...
    , msg_Submission_AssignmentNotAvailableYet <| "A feladat még nem elérhető."
    , msg_Submission_DeadlineReached <| "Lejárt a határidő"
    , msg_Submission_SubmissionFormDeadlineReached <| "Lejárt a határidő."
    ...
    , msg_Submission_Info <| "A beadott megoldásokhoz a beadás után még hozzászólások írhatók."
    , msg_Submission_Info_Password <| "Ezt a feladatot csak a jelszó megadásával lehet beküldeni."
    , msg_Submission_Info_File <| "Válasszuk ki a beadni kívánt .zip állományt!  A maximális méret kilobyte-ban: "
    ...
    , msg_Submission_File_InvalidFile <| "Az állomány nem tűnik zip fájlnak. Rossz a kiterjesztés és az állomány szignatúrája."
    ...
    , msg_Submission_LimitReached <| "Elfogyott a feltöltési lehetőségek száma."
    , msg_Submission_Large_Submission <| "A megoldás túl nagy, megtekinthető erre a linkre kattintva."
    , msg_Submission_NoSubmittedSolutions <| "Nincsenek beadott megoldások."
    , msg_Submission_NotFound <| "Megoldás nem található."
    , msg_Submission_NotEvaluatedYet <| "Még nem értékelt"
    , msg_Submission_TestsPassed <| "Átment a teszteken"
    , msg_Submission_TestsFailed <| "Megbukott a teszteken"
    , msg_Submission_Passed <| "Elfogadva"
    , msg_Submission_Failed <| "Elutasítva"
    , msg_Submissions_Title <| "Megoldások"
    ...
    , msg_Comments_QueuedForTest <| "A megoldás sorba lett állítva tesztelésre."
    ...
    , msg_Evaluation_Submitted_Solution_Download <| "Letöltés"
    , msg_Evaluation_Submitted_Solution_Zip_Info <| "A megoldás tömörített állományként lett feltöltve, ezért nem jeleníthető meg."
    ...
    , msg_Evaluation_NotTheLatest <| "Jelenleg nem a legújabb megoldását nézed a hallgatónak. A legújabb megtekintéséhez kattints erre a linkre."
    , msg_Evaluation_ShouldNotEvaluate <| "Ennek a megoldásnak az értékelése nem lesz látható a hallgató főoldalán. Javasolt a legújabb megoldást értékelni, melyhez kattints erre a linkre."
    , msg_Evaluation_EvaluationOrComment <| "Értékelés vagy megjegyzés"
    ...
    , msg_SubmissionDetails_Course <| "Tárgy:"
    ...
    , msg_SubmissionDetails_BallotBox_Comment_Info <| "Urna mód esetén a határidő lejártáig a hallgatói hozzászólások nem láthatók."
    ...
    , msg_Navigation_RegisteredCourses <| "Felvett tárgyak"
    , msg_Navigation_AdminedGroups <| "Csoportok"
    , msg_Navigation_AdminedCourses <| "Tárgyak"
    ...
    , msg_Home_SubmissionTable_Info <| "A feladat sorszámára kattintva módosítható már kiírt feladat, ha van jogosultságunk a feladat módosításához (a nevét ld. tooltipben).  Hallgatók törölhetők kurzusról vagy csoportból a Törlés oszlopban bejelölve, majd a gombra kattintva."
    , msg_Home_CourseSubmissionTableList_Info <| "A kurzusokhoz tartozó összesítő táblázatok külön oldalon találhatók. Kattintsunk a kurzus nevére az alábbi listában."
    ...
    , msg_Home_EvaluationLink_Hint <| "**Tipp**: Egyből a megoldásodhoz ugorhatsz egy linkre kattintva az Értékelés oszlopban."
    , msg_Home_SubmissionCell_NoSubmission <| "Nincs megoldás"
    , msg_SubmissionState_NonEvaluated <| "Nem értékelt"
    , msg_SubmissionState_QueuedForTest <| "Sorban áll tesztelésre"
    , msg_SubmissionState_Tests_Passed <| "Átment a teszteken"
    , msg_SubmissionState_Tests_Failed <| "Megbukott a teszteken"
    , msg_SubmissionState_Accepted <| "Elfogadott"
    , msg_SubmissionState_Rejected <| "Elutasított"
    , msg_SubmissionState_FreeFormEvaluated <| "Értékelt"
    ...
    , msg_ExportEvaluations_Assessments <| "eredmények"
    , msg_ExportEvaluations_Evaluations <| "értékelések"
    , msg_ExportSubmissions_Comments <| "hozzászólások"
    ...
    , msg_UserStoryError_AssignmentNotAvailableYet <| "A feladat még nem elérhető."
    ...
    , msg_UserStoryError_InvalidUsernameOrPassword <| "Rossz felhasználónév vagy jelszó."
    , msg_UserStoryError_NoCourseAdminOfCourse <| "Nem oktatója a kurzusnak."
    , msg_UserStoryError_NoAssociatedTestScript <| "Ez a tesztelő nem ehhez a felhasználóhoz tartozik, ezért nem módosítható."
    ...
    , msg_UserStoryError_NonAdministratedCourse <| "Nem vagy felelőse a kurzusnak."
    ...
    , msg_UserStoryError_NonAdministratedTestScript <| "Nem vagy felelőse a teszt szkript kurzusának."
    , msg_UserStoryError_NonCommentableSubmission <| "Nem kommentelhető feladat."
    , msg_UserStoryError_BlockedAssignment <| "A feladatot egy izolált feladat blokkolja."
    ...
    , msg_UserStoryError_NonAccessibleSubmission <| "A megoldás nem érhető el."
    , msg_UserStoryError_NonAccessibleScore <| "Az eredmény nem érhető el."
    ...
    , msg_LinkText_Welcome <| "Kezdőlap"
    , msg_LinkText_Profile <| "Beállítások"
    , msg_LinkText_GroupOverviewAsStudent <| "Csoport megtekintése hallgatói szemmel"
    , msg_LinkText_GroupManagement <| "Csoportok kezelése"
    , msg_LinkText_CourseOverview <| "Tárgy áttekintése"
    ...
    , msg_LinkText_TestScripts <| "Tesztelők"
    ...
    , msg_LinkText_QueueSubmissionForTest <| "Teszt futtatása"
    , msg_LinkText_QueueAllSubmissionsForTest <| "Teszt futtatása a megoldásokon"
    , msg_LinkText_ExportEvaluations <| "Saját csoportok értékeléseinek exportálása a tárgyon belül"
    , msg_LinkText_ExportEvaluationsAllGroups <| "Összes csoport értékeléseinek exportálása a tárgyon belül"
    , msg_LinkText_ExportSubmissions <| "Összes megoldás exportálása"
    , msg_LinkText_ExportSubmissionsOfGroups <| "Saját csoportok exportálása"
    , msg_LinkText_ExportSubmissionsOfOneGroup <| "Jelenlegi csoport exportálása"
    ...
    , msg_LinkText_SimilarityCheckMoss <| "Megoldások hasonlóságának vizsgálata"
    , msg_LinkText_ViewMossScriptOutput <| "Hasonlóságvizsgálat jelentésének megtekintése"
    ...
    , msg_SeeMore_SeeMore <| "Megtekintés"
    , msg_Markdown_NotFound <| "Sajnos a kért oldal nem található."
    , msg_Moss_Info <| "A megoldások hasonlóságának vizsgálatára Mosst, egy külső eszközt használunk. Többet megtudhat Mossról a honlapján:"
    , msg_Moss_ProgrammingLanguage <| "Megoldások programozási nyelve"
    , msg_Moss_ChooseProgrammingLanguage <| "Programozási nyelv kiválasztása"
    , msg_Moss_Submit <| "Megoldások elküldése hasonlóság vizsgálatára"
    , msg_Moss_ReportIsDone <| "A vizsgálati jelentés elkészült, és megtekinthető az alábbi címen."
    , msg_Moss_ErrorDuringSending <| "Hiba történt miközben a megoldásokat elküldtük hasonlósági vizsgálatra. Az alábbi napló tartalmazza a folyamat részleteit."
    , msg_Moss_ReportIsNotYetReady <| "A jelentés még nem készült el."
    , msg_Moss_WeAreRefreshingThePage <| "Frissítjük az oldalt"
    , msg_Moss_EveryNSeconds <| "%s másodpercenként"
    , msg_Moss_PleaseBePatient <| "Türelmét kérjük, amíg a jelentés elkészül. Nem tart sokáig."
    , msg_Moss_NoTextualSubmission <| "Nem találtunk szöveges megoldást a feladathoz. A hasonlósági vizsgálat csak szöveges megoldásokkal használható."
    , msg_Moss_NoSubmissions <| "Jelenleg nincsenek megoldások a feladathoz. Nincs min elvégezni a hasonlósági vizsgálatot."
    , msg_Moss_OnlyOneTextualSubmission <| "Eddig csak egy szöveges megoldás érkezett a feladathoz. Legalább kettőnek kell lennie a hasonlóság vizsgálatához."
